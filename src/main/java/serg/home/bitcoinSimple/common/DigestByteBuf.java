 ...
 */
public class DigestByteBuf extends ByteBuf {
    ...
    public DigestByteBuf(ByteBuf buf) {
        if (buf == null) {
    ...
    // TODO test it
    public DigestByteBuf doubleSha256() {
//        sha256Digest.update(this.nioBuffer());
//        byte[] digest1 = sha256Digest.digest(bytes);
//        byte[] digest2 = sha256Digest.digest(digest1);
//        return new Bytes(digest2);
        return null;
    }

    public DigestByteBuf sha256() {
//        try {
...
//        }
    ...
    public DigestByteBuf ripeMD160() {
        return null;
//        ripemd160Digest.update(bytes, 0, bytes.length);
//        byte[] result = new byte[ripemd160Digest.getDigestSize()];
