...
import serg.home.bitcoinSimple.network.model.block.BlockVersion;
import serg.home.bitcoinSimple.network.model.block.Difficulty;
...
public class TestnetConfig {
    ...
    public Block genesis() {
        BlockHeader blockHeader = new BlockHeader(
                ...
                Unpooled.wrappedBuffer(ByteBufUtil.decodeHexDump("4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b")),
                new Timestamp4(1296688602L),
                new Difficulty(Unpooled.wrappedBuffer(ByteBufUtil.decodeHexDump("1d00ffff"))),
                414098458
        );
        CoinbaseInput input = new CoinbaseInput(
                new CoinbaseData(null, ByteBufUtil.decodeHexDump((
        ...
        Output output = new Output(
                5_000_000_000L,
                new Script().__(Unpooled.wrappedBuffer(ByteBufUtil.decodeHexDump("04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f"))).__(OP.CHECKSIG)
        );
