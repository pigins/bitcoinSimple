...
public class ProtocolVersion implements BinaryEncoded, BinaryDecoded, Comparable<ProtocolVersion> {
    ...
    public ProtocolVersion(ByteReader byteReader) {
        decode(byteReader);
    }
